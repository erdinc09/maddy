...
class MADDY_ORDEREDLISTPARSER : public ::testing::Test {
 protected:
  std::unique_ptr<maddy::OrderedListParser> olParser;
  ...
  void SetUp() override {
        ...
        getBlockParserForLineCallback = [](const std::string& line) {
          if (maddy::OrderedListParser::IsStartingLine(line)) {
            std::unique_ptr<maddy::BlockParser> parser =
                std::make_unique<maddy::OrderedListParser>(nullptr, nullptr);
            return parser;
          }
    ...
    this->olParser = std::make_unique<maddy::OrderedListParser>(
...
TEST_F(MADDY_ORDEREDLISTPARSER,
...
TEST_F(MADDY_ORDEREDLISTPARSER, ItReplacesMarkdownWithAnHierachicalHtmlList) {
  std::vector<std::string> markdown = {"1. a", "  1. d", "  * e",
                                       "* b",  "  1. c", ""};
  std::string expected =
      "<ol><li>a<ol><li>d</li><li>e</li></ol></li><li>b<ol><li>c</li></ol></"
      "li></ol>";
...
TEST_F(MADDY_ORDEREDLISTPARSER,
       ItReplacesNumberedMarkdownListWithAnHtmlOrderedList) {
